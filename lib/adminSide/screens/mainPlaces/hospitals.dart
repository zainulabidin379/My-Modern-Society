          ...
          FutureBuilder<dynamic>(
              ...
              builder: (_, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Column(
                    children: [
                      addHospitalButton(size, 'Add New Hospital'),
...
//New hospitals Button
  Widget addHospitalButton(Size size, String name) {
    return GestureDetector(
      onTap: () {
        Get.to(() => AddNewPlace(place: 'Hospital',));
      },
      child: Padding(
        ...
        children: [
          Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  Get.to(()=> UpdatePlace(id: name, place: 'Hospital',));
                },
                child: Container(
                  height: 50,
