...
class _MosquesState extends State<Mosques> {
  Future getMosques() async {
    var firestore = FirebaseFirestore.instance;
    QuerySnapshot qn = await firestore.collection('mosques').get();
          ...
          FutureBuilder<dynamic>(
              ...
              builder: (_, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Column(
                    children: [
                      addMosqueButton(size, 'Add New Mosque'),
...
//New mosque Button
  Widget addMosqueButton(Size size, String name) {
    return GestureDetector(
      onTap: () {
        Get.to(() => AddNewPlace(place: 'Mosque',));
      },
      child: Padding(
        ...
        children: [
          Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  Get.to(()=> UpdatePlace(id: name, place: 'Mosque',));
                },
                child: Container(
                  height: 50,
