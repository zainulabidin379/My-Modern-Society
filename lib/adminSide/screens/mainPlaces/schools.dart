...
class _SchoolsState extends State<Schools> {
  Future getSchools() async {
    ...
    QuerySnapshot qn = await firestore.collection('schools').get();
          ...
          FutureBuilder<dynamic>(
              ...
              builder: (_, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Column(
                    children: [
                      addSchoolButton(size, 'Add New School'),
...
//New school Button
  Widget addSchoolButton(Size size, String name) {
    return GestureDetector(
      onTap: () {
        Get.to(() => AddNewPlace(place: 'School',));
      },
      child: Padding(
        ...
        children: [
          Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  Get.to(()=> UpdatePlace(id: name, place: 'School',));
                },
                child: Container(
                  height: 50,
