...
class UnresolvedComplaints extends StatefulWidget {
  UnresolvedComplaints({Key? key}) : super(key: key);
...
class _UnresolvedComplaintsState extends State<UnresolvedComplaints> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        title: Text('Unresolved Complaints'),
                  ...
                  return Column(
                    children: [
                      for (var i = 0; i < snapshot.data.length; i++)
                        snapshot.data[i]['resolved']? SizedBox() : complaintCard(
                          size,
                          snapshot.data[i]['uid'],
                      ...
                      (unresolvedComplaints == 0)? noComplaints(size, 'No Complaints here!'): SizedBox()
                    ],
                  );
                }
              }),
...
//No Users
  ...
  Widget complaintCard(Size size, String? uid, String subject, String name, String address,
      String details, bool? resolved, Timestamp date) {
              ...
              onTap: () {
                showDialog(
                  ...
                  builder: (context) => new AlertDialog(
                    ...
                    content: new Text('Do you want to mark this complaint as resolved?'),
                    actions: <Widget>[
                      new TextButton(
                      ...
                      new TextButton(
                        onPressed: () async {
                          ...
                          Get.snackbar(
                            'Message',
                            'Complaint is marked as resolved resolved',
                        ...
                        child:
                            new Text('Resolved', style: TextStyle(color: kGreen)),
                      ),
                    ],
                  ),
                );
                ...
                child: Center(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text('Mark as Resolved', style: TextStyle(color: kWhite, fontSize: 22, fontWeight: FontWeight.bold,)),
                    )
                  ],
                )),
              ),
