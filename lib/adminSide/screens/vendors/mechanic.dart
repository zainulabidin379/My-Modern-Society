          ...
          FutureBuilder<dynamic>(
              ...
              builder: (_, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Column(
                    children: [
                      addVendor(size, 'Add New Mechanic'),
            ...
            children: [
              Ink(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Get.to(()=> UpdateVendor(vendor: 'Mechanic', id: phone,));
                  },
                  child: Container(
                  ...
                  onTap: () {
                    showDialog(
                      ...
                      builder: (context) => new AlertDialog(
                        ...
                        content: new Text('Do you want to delete this mechanic?'),
                        actions: <Widget>[
                          new TextButton(
                          ...
                          new TextButton(
                            onPressed: () async {
                              ...
                              Get.snackbar(
                                'Message',
                                'Mechanic is deleted from database',
