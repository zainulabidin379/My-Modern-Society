          ...
          FutureBuilder<dynamic>(
              ...
              builder: (_, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Column(
                    children: [
                      addVendor(size, 'Add New Electrician'),
            ...
            children: [
              Ink(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Get.to(()=> UpdateVendor(vendor: 'Electrician', id: phone,));
                  },
                  child: Container(
                  ...
                  onTap: () {
                    showDialog(
                      ...
                      builder: (context) => new AlertDialog(
                        ...
                        content: new Text('Do you want to delete this electrician?'),
                        actions: <Widget>[
                          new TextButton(
                          ...
                          new TextButton(
                            onPressed: () async {
                              ...
                              Get.snackbar(
                                'Message',
                                'Electrician is deleted from database',
