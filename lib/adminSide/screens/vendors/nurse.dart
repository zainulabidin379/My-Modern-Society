...
class _NurseState extends State<Nurse> {
  Future getVendor() async {
    ...
    QuerySnapshot qn = await firestore.collection('nurses').orderBy('timestamp', descending: true).get();
            ...
            children: [
              Ink(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Get.to(()=> UpdateVendor(vendor: 'Nurse', id: phone,));
                  },
                  child: Container(
                  ...
                  onTap: () {
                    showDialog(
                      ...
                      builder: (context) => new AlertDialog(
                        ...
                        content: new Text('Do you want to delete this nurse?'),
                        actions: <Widget>[
                          new TextButton(
                          ...
                          new TextButton(
                            onPressed: () async {
                              ...
                              Get.snackbar(
                                'Message',
                                'Nurse is deleted from database',
