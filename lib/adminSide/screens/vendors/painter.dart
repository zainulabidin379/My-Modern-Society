          ...
          FutureBuilder<dynamic>(
              ...
              builder: (_, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Column(
                    children: [
                      addVendor(size, 'Add New Painter'),
            ...
            children: [
              Ink(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Get.to(()=> UpdateVendor(vendor: 'Painter', id: phone,));
                  },
                  child: Container(
                  ...
                  onTap: () {
                    showDialog(
                      ...
                      builder: (context) => new AlertDialog(
                        ...
                        content: new Text('Do you want to delete this painter?'),
                        actions: <Widget>[
                          new TextButton(
                          ...
                          new TextButton(
                            onPressed: () async {
                              ...
                              Get.snackbar(
                                'Message',
                                'Painter is deleted from database',
