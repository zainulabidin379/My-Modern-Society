...
class _CarpenterState extends State<Carpenter> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: kBg,
      appBar: AppBar(
        title: Text('Available Carpenters'),
          ...
          FutureBuilder<dynamic>(
              ...
              builder: (_, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Column(
                    children: [
                      addVendor(size, 'Add New Carpenter'),
                  ...
                  onTap: () {
                    showDialog(
                      ...
                      builder: (context) => new AlertDialog(
                        ...
                        content: new Text('Do you want to delete this carpenter?'),
                        actions: <Widget>[
                          new TextButton(
                          ...
                          new TextButton(
                            onPressed: () async {
                              ...
                              Get.snackbar(
                                'Message',
                                'Carpenter is deleted from database',
