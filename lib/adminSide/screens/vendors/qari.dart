...
class Qari extends StatefulWidget {
  Qari({Key? key}) : super(key: key);

  @override
  _QariState createState() => _QariState();
}
            ...
            children: [
              Ink(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Get.to(()=> UpdateVendor(vendor: 'Qari', id: phone,));
                  },
                  child: Container(
                  ...
                  onTap: () {
                    showDialog(
                      ...
                      builder: (context) => new AlertDialog(
                        ...
                        content: new Text('Do you want to delete this qari?'),
                        actions: <Widget>[
                          new TextButton(
