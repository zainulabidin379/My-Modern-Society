...
class Qariya extends StatefulWidget {
  Qariya({Key? key}) : super(key: key);

  @override
  _QariyaState createState() => _QariyaState();
}
                  ...
                  onTap: () {
                    showDialog(
                      ...
                      builder: (context) => new AlertDialog(
                        ...
                        content: new Text('Do you want to delete this qariya?'),
                        actions: <Widget>[
                          new TextButton(
                          ...
                          new TextButton(
                            onPressed: () async {
                              ...
                              Get.snackbar(
                                'Message',
                                'Qariyas is deleted from database',
