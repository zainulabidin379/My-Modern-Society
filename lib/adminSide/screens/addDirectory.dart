...
class AddNewDirectory extends StatefulWidget {
  AddNewDirectory({Key? key}) : super(key: key);

  @override
  _AddNewDirectoryState createState() => _AddNewDirectoryState();
}

class _AddNewDirectoryState extends State<AddNewDirectory> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Add New Directory Contact'),
                                      ...
                                      for (var i = 0;
                                        ...
                                        FirebaseFirestore.instance
                                            ...
                                            .set({
                                              ...
                                              "isRead": false,
                                              "notification":
                                                  'A new directory contact has been added, go and check it out in Directory section.',
                                            })
                                            .then((_) {})
                                            .catchError((onError) {
