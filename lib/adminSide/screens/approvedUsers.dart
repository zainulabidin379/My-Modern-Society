...
class _ApprovedUsersState extends State<ApprovedUsers> {
  Future getUsers() async {
    ...
    QuerySnapshot qn = await firestore.collection('users').orderBy('timestamp').get();
                  ...
                  return Column(
                    ...
                    children: [
                      for (var i = 0; i < snapshot.data.length; i++)
                        snapshot.data[i]['isApproved']? eventCard(
                          size,
                          snapshot.data[i]['uid'],
                        ...
                        (approvedUsers == 0)? noUsers(size, 'No Users here!'): SizedBox(),
                    ],
                  );
                }
              }),
 ...
 //No Users
  ...
  Widget eventCard(Size size, String? uid, String name, String email, String cnic,
      String address, String gender, bool? verified, Timestamp date) {
        approvedUsers++;
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 6.0, vertical: 8),
      child: Center(
            ...
            GestureDetector(
              onTap: () {
                showDialog(
                  ...
                  builder: (context) => new AlertDialog(
                    ...
                    content: new Text('Do you want to disapprove this user?'),
                    actions: <Widget>[
                      new TextButton(
                      ...
                      new TextButton(
                        onPressed: () async {
                          ...
                          FirebaseFirestore.instance
                              ...
                              .set({
                                ...
                                "isRead": false,
                                "notification":
                                    'Your Account has been marked as disapproved.',
                              })
                              .then((_) {})
                              .catchError((onError) {
                        ...
                        child:
                            new Text('Disapprove', style: TextStyle(color: Colors.red)),
                      ),
                    ],
                  ),
                );
              ...
              child: Container(
                ...
                Padding(
                  ...
                  child: Text('Disapprove User', style: TextStyle(color: kWhite, fontSize: 22, fontWeight: FontWeight.bold,)),
                )
                  ],
                ),
              ),
