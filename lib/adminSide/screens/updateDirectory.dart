...
class UpdateDirectory extends StatefulWidget {
  final String id;
  UpdateDirectory({Key? key, required this.id}) : super(key: key);

  @override
  _UpdateDirectoryState createState() => _UpdateDirectoryState();
}

class _UpdateDirectoryState extends State<UpdateDirectory> {
  ...
  Future getDirectory() async {
    ...
    var qn = await firestore.collection('directory').doc(widget.id).get();
    setState(() {
      nameController.text = qn.get('name');
      phoneController.text = qn.get('phone');
      designationController.text = qn.get('designation');
    });
  }
                          ...
                          child: TextFormField(
                            ...
                            validator: FieldValidator.multiple([
                              ...
                              FieldValidator.minLength(11,
                                  message:
                                      'Please enter a valid phone (03001234567)'),
